...
if [ -f "$INSTALL_DIR/ns-2.35/ns" ] && [ -f "$INSTALL_DIR/nam-1.15/nam" ]; then
    ...
    export PATH="$INSTALL_DIR/ns-2.35:$INSTALL_DIR/nam-1.15:$INSTALL_DIR/tcl8.5.10/unix:$INSTALL_DIR/tk8.5.10/unix:$PATH"
    ...
    echo "export PATH=\"$INSTALL_DIR/ns-2.35:$INSTALL_DIR/nam-1.15:$INSTALL_DIR/tcl8.5.10/unix:$INSTALL_DIR/tk8.5.10/unix:\$PATH\"" >> "$PROFILE_FILE"
